...
# 모델 로드
# ======================
FILE_ID = st.secrets.get("GDRIVE_FILE_ID", "1xp8zmBRQMKqG4tOApeNQy_eCZWINfn9q")
...
CONTENT_BY_LABEL: dict[str, dict[str, list[str]]] = {
     ...
     labels[0]: {
       "texts": ["이 문서에서 설명하는 요리는 버터, 파르미지아노 레지아노, 면수를 넣어 만든 베샤멜 소스의 변종인 알프레도 소스(Alfredo Sauce) 또는 이와 유사한 크림 기반의 소스를 사용하는 파스타 요리이다", " '느끼한 양식(洋食)'이라고 하면 가장 먼저 떠오르는 메뉴이기도 하다.
", "지역별 스타일 차이"],
